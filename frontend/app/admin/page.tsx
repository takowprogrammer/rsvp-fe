...
export default function AdminDashboard() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-dusty-blue-50 via-white to-nude-50 p-6">
      {/* Admin Menu Bar */}
        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="px-4 py-2 rounded-md bg-white/20 text-white font-medium hover:bg-white/30 transition-all duration-200 backdrop-blur-sm border border-white/30"
            >
              🏠 Wedding Home
            </button>
            <button
              ...
              className="px-4 py-2 rounded-md bg-dusty-blue-800 text-white font-medium hover:bg-dusty-blue-900 transition-all duration-200 border border-dusty-blue-700"
            >
              Logout
            </button>
          </div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-dusty-blue-500 via-dusty-blue-600 to-dusty-blue-700">
        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-20">
          <div className="text-center text-white">
            ...
            <p className="text-xl md:text-2xl text-dusty-blue-100 max-w-2xl mx-auto">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 -mt-8 relative z-10">
        {/* Quick Actions */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 mb-8 border border-dusty-blue-200/50">
          <h3 className="text-2xl font-bold text-gray-800 mb-6">Quick Actions</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/admin/invitations" className="group flex items-center p-6 bg-gradient-to-br from-amber-50 to-orange-50 hover:from-amber-100 hover:to-orange-100 rounded-2xl border border-amber-200 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
            ...
            <Link href="/admin/invitations/new" className="group flex items-center p-6 bg-gradient-to-br from-dusty-blue-50 to-dusty-blue-100 hover:from-dusty-blue-100 hover:to-dusty-blue-200 rounded-2xl border border-dusty-blue-200 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
              <div className="p-3 bg-dusty-blue-100 rounded-xl group-hover:bg-dusty-blue-200 transition-colors duration-300">
                <svg className="w-8 h-8 text-dusty-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/admin/guests" className="group flex items-center p-6 bg-gradient-to-br from-amber-50 to-orange-50 hover:from-amber-100 hover:to-orange-100 rounded-2xl border border-amber-200 transition-all duration-300 transform hover:scale-105 hover:shadow-xl">
              <div className="p-3 bg-amber-100 rounded-xl group-hover:bg-amber-200 transition-colors duration-300">
                <svg className="w-8 h-8 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {extended && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {/* Attendance Card */}
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-dusty-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-dusty-blue-100 rounded-xl mr-4">
                  <svg className="w-8 h-8 text-dusty-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-3">
                ...
                <select
                  ...
                  className="border border-dusty-blue-300 rounded-xl px-4 py-2 text-sm bg-white focus:ring-2 focus:ring-dusty-blue-500 focus:border-transparent transition-all duration-200"
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  ...
                  className="text-sm border border-dusty-blue-300 rounded-xl px-4 py-2 bg-white focus:ring-2 focus:ring-dusty-blue-500 focus:border-transparent transition-all duration-200"
                />
              </div>
            </div>
            <div className="flex justify-end">
              <button
                ...
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-dusty-blue-500 to-dusty-blue-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105"
        ...
        {/* Guest List */}
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-dusty-blue-200/50">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                href="/admin/guests"
                className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-dusty-blue-500 to-dusty-blue-600 rounded-xl hover:from-dusty-blue-600 hover:to-dusty-blue-700 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full border border-dusty-blue-200 rounded-xl overflow-hidden">
              <thead className="bg-gradient-to-r from-dusty-blue-50 to-dusty-blue-100">
                <tr>
                  <th className="border border-dusty-blue-200 px-4 py-3 text-left text-sm font-semibold text-gray-700">Name</th>
                  <th className="border border-dusty-blue-200 px-4 py-3 text-left text-sm font-semibold text-gray-700">Email</th>
                  <th className="border border-dusty-blue-200 px-4 py-3 text-left text-sm font-semibold text-gray-700">Group</th>
                  <th className="border border-dusty-blue-200 px-4 py-3 text-left text-sm font-semibold text-gray-700">QR Code</th>
                </tr>
              </thead>
              <tbody>
                {filteredGuests.slice(0, 10).map((guest, index) => (
                  ...
                  >
                    <td className="border border-dusty-blue-200 px-4 py-3">
                    ...
                    <td className="border border-dusty-blue-200 px-4 py-3">
                      <span className="text-gray-600">{guest.group?.name || '-'}</span>
                    </td>
                    <td className="border border-dusty-blue-200 px-4 py-3">
                      <span className="text-gray-600 font-mono text-sm">{guest.qrCode?.alphanumericCode || '-'}</span>
                    </td>
                  </tr>
                ))}
              </tbody>
