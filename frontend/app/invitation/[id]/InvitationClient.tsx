    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-dusty-blue-50 via-white to-nude-50 flex items-center justify-center">
        <div className="text-center">
          <div className="mx-auto mb-3 h-10 w-10 rounded-full border-2 border-dusty-blue-600 border-t-transparent animate-spin" />
          <p className="text-dusty-blue-600">Loading invitation...</p>
        </div>
      </div>
    );
  }
